...
fun unconj_hyp_rule term thm =
  ...
  else raise BASICRULE_ERR "unconj_hyp_rule" ""
...
fun repeat_rule n rule thm =   
  case n of
    0 => thm
  | _ => if n < 0 then raise BASICRULE_ERR "repeat_rule" ""
...
fun list_TRANS eqthml =
  case eqthml of
    [] => raise BASICRULE_ERR "list_TRANS" "no argument"
  | [eqthm] => eqthm
