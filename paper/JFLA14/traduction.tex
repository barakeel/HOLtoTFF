...
\item \textbf{Monomorphisation}: Meng et Paulson~\cite{MengP08} ont
  ...
  \item Mise sous forme d'un ensemble de clauses par élimination des
    quantificateurs existentiels et distribution des quantificateurs
    universels par rapport au conjonctions.
