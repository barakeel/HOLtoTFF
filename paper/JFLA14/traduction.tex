...
La transformation $\mathcal{T}$ d'un graphe de dépendance $G$ est défini comme l'application de toutes les transformations de substitution et de partage possible à ce graphe de façon simultanée. Soit $G_0$ le graphe d'un problème, nous appellerons $G_1,G_2,\ldots,G_i$ les graphes créés après $1,2,\ldots,i$ itérations de $\mathcal{T}$.
=======
