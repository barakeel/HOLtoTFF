...
\item \textbf{Monomorphisation}: \cite{MengP08} a montré qu'il était
  ...
  \item Mise sous forme d'un ensemble de clauses par élimination des     quantifcateurs existentiels et distribution des quantificateurs universels par rapport au conjonctions.
...
correspondre à la distinction au premier ordre entre variables. Un éventail de traduction de types sont présentés dans \cite{Blanchette12}\cite{BlanchetteBPS13}\cite{MengP08}.
