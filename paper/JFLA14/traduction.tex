...
\begin{enumerate}
\item \textbf{Monomorphisation}: Meng et Paulson~\cite{MengP08} ont
  montré qu'il était préférable -- notamment pour des raisons
  ...
  \item \textbf{$\lambda$-lifting}: cette étape consiste à éliminer les
    variables libres apparaissant dans des définitions locale.
...
Nous présentons maintenant quelques détails pratiques pour implanter
notre traduction.
