...
\paragraph{Lors de l'impression}, des dictionnaires injectifs pour les variables et les constantes sont créées, ce qui  augmente la sûreté de l'impression et permettra de rejouer la preuve plus tard. De plus, les types doivent être traduit pour correspondre à la distinction au premier ordre entre variables, fonctions et prédicats. (voir ref type TFF)
Exemple:
